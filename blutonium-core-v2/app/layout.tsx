...
export const metadata = { title: 'Blutonium Records', description: 'Since 1995 — Hardstyle / Hardtrance' }
export default function RootLayout({ children }:{children:React.ReactNode}) {
  return (
    <html lang="de"><body className="min-h-screen bg-techno-1">
      <header className="sticky top-0 z-50 backdrop-blur bg-black/40 border-b border-zinc-800">
        <nav className="max-w-6xl mx-auto px-4 py-3 flex items-center gap-6">
          <Link href="/de" className="font-bold tracking-widest text-blutonium-500">BLUTONIUM</Link>
      ...
      <footer className="border-t border-zinc-800 py-10 mt-16 text-sm opacity-80">
        <div className="max-w-6xl mx-auto px-4">© {new Date().getFullYear()} Blutonium Records — Since 1995</div>
      </footer>
    </body></html>
  )
}
